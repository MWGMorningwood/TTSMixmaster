playlist = {
    {
        title = "Ayla - Ayla, Pt. 2",
        url = "",
    },
    {
        title = "BENNETT - Vois sur ton chemin (Techno Mix)",
        url = "",
    },
    {
        title = "Binary Finary - 1998 (Kay Cee 1999 Radio Mix)",
        url = "",
    },
    {
        title = "Daft Punk - Around the World (Radio Edit)",
        url = "",
    },
    {
        title = "Darude - Sandstorm (Radio Edit)",
        url = "",
    },
    {
        title = "TesseracT - The Grey",
        url = "",
    },
    {
