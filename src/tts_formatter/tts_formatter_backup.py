...
class TTSFormatter:
    ...
    def create_music_player(self, playlist: Playlist, 
        ...
        Args:
            ...
            workshop_results: List of workshop upload results
...
"""
    ...
    def generate_save_file(self, music_player: TTSMusicPlayer, 
        ...
        return save_data    def save_formatted_files(self, music_player: TTSMusicPlayer, 
        ...
        # Save TTS save file
        save_data = self.generate_save_file(music_player)
...
"""
    ...
    def batch_format_playlists(self, playlists: List[Playlist],
                              workshop_results: List[List[UploadResult]] = None,
                              local_files: List[List[str]] = None) -> List[Dict[str, str]]:
        """
